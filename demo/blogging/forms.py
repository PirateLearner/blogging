...
class LayoutListForm(forms.Form):
	Layout = forms.ModelChoiceField(
					queryset=Layout.objects.all(),
					empty_label=None,
					required = True,
					label = "Select Layout format or Create New!",
...
# 	tags = TagField()
# 	section = forms.ModelChoiceField(queryset= Section.objects.filter(children=None) , empty_label=None)
...
class PageForm(forms.Form):
	...
	parent = forms.ModelChoiceField(queryset= Section.objects.filter(children=None) , empty_label=None)
	content_type = forms.ModelChoiceField(queryset = ContentType.objects.all(),empty_label=None)
